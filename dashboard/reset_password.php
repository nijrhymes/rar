        ...
        <div class="row">
            <div class="col-6">
                <div class="form-group mb-3">
                 <br>   <button type="submit" class="btn btn-primary login-btn btn-block">Reset Password</button>    <a class="btn btn-primary login-btn btn-block" href="index.php">Cancel</a>
                </div>
            </div>
           
        </div>
		<div class="or-seperator"><i>Check</i></div>
