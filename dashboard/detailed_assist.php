...
<!DOCTYPE html>
			...
			<div id="page-wrapper" class="gray-bg dashbard-1">
				...
				<div class="wrapper wrapper-content">
                    <div class="row wrapper border-bottom white-bg page-heading">
                        <div class="col-lg-10">
                            <h2>User's Assist Booked Details</h2>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">
                                    <strong>Detailed Assist Booked User</strong>
                                </li>
                            </ol>
                        </div>
                    </div>
    ...
    if (isset($_GET['ID'])) {
          ...
          include('../include/connection.php');
            if (!empty($ID)) {
                ...
                $query = "SELECT * FROM booking_assist WHERE ID=$ID ";
    ...
    ?>			
                            ...
                            <div class="mail-box-header">
                                ...
                                <h2>
                                    Assist this User to Book
                                </h2>
                                <div class="mail-tools tooltip-demo m-t-md">


                                    <h3>
                                        <span class="font-normal">User's Full Name: </span><?php echo htmlentities($row['fullname']);?>
                                    </h3>
                                    <h5>
                                ...
                                <div class="mail-box">
                                    <div class="mail-body">
                                        <p>
                                            ...
                                            <br/>
                                            <br/>
                                            <?php echo htmlentities($row['fullname']);?> just booked for an accomodation type is <?php echo htmlentities($row['university']);?> university which the name of the accomodation is <?php echo htmlentities($row['accommodationid']);?>  
                                           </p>
                                            <p> Country <?php echo htmlentities($row['fullname']);?>  selected <?php echo htmlentities($row['country']);?>
                                            and his/her arrival date to the accomodation is <?php echo htmlentities($row['eta']);?>
                                             And Option of Pickup <?php echo htmlentities($row['pickup']);?>
